...
public class JSONResult {
    ...
    public static JSONResult errorMsg(Map<String, String> msg) {
    ...
    public JSONResult(int status, Map<String, String> msg, Object data) {
    ...
    public static JSONResult errorMsg(String 文件大小不能超过500KB) {
        return null;
    }
